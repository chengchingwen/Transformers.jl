...
hgf_model_safetensor_weight(model_name; kws...) = hgf_file(model_name, SAFE_WEIGHTS_NAME; kws...)
hgf_model_safetensor_weight_index(model_name; kws...) = hgf_file(model_name, SAFE_WEIGHTS_INDEX_NAME; kws...)
