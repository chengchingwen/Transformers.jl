# code take from https://github.com/JuliaCollections/DataStructures.jl/blob/master/src/trie.jl
# DataStructures haven't release a version with this code. Should be remove once it got tagged.
...
function find_prefixes(t::Trie{T}, str) where {T}
    prefixes = Vector{T}[]
